package com.kangyonggan.app.future.biz.aspect;


import com.kangyonggan.app.future.biz.util.PropertiesUtil;
import com.kangyonggan.app.future.common.util.AspectUtil;
...
public class LogAspect {
    ...
    @Pointcut("execution(* com.kangyonggan.app.future.biz..*.*(..))")
