...
<tr id="user-${user.id}">
    ...
    <td>
        <div class="btn-group">
            <a class="btn btn-xs btn-inverse" href="#system/user/${user.username}">查看</a>
            ...
            <ul class="dropdown-menu dropdown-menu-right dropdown-inverse">
                <li>
                    <a href="${ctx}/dashboard/system/user/${user.username}/edit" data-toggle="modal" data-target="#myModal"
