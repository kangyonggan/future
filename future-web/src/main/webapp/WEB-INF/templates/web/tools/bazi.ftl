...
<div>
    ...
    <form action="#tools/bazi" method="post" id="bazi-form">
        <div class="form-group">
            <label for="exampleInputEmail1">阴/阳历：</label>
        ...
        <div class="form-group">
            <label for="exampleInputEmail1">出生时辰：</label>
